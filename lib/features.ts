...
export const features: Feature[] = [
  ...
  /* ──────────────────────────────────────────────────────────────────────── */
  {
    ...
    keywords: [
      ...
      "tmux alternative gui",
      "terminal with tabs and panes",
  ...
  /* ──────────────────────────────────────────────────────────────────────── */
  {
    ...
    keywords: [
      ...
      "nano alternative gui",
      "vim alternative for quick edits",
      "open file at line from stack trace",
      "atomic file save editor",
      "crlf preserving editor",
      "fuzzy file finder terminal",
    ],
  ...
  /* ──────────────────────────────────────────────────────────────────────── */
  {
    ...
    keywords: [
      ...
      "lsp client editor",
      "rust analyzer editor",
      "typescript language server editor",
      "go to definition terminal editor",
      "inline diagnostics editor",
  ...
  /* ──────────────────────────────────────────────────────────────────────── */
  {
    ...
    keywords: [
      ...
      "native webview browser panel",
      "read docs beside terminal",
    ],
    heroShot: "browser",
    highlights: [
      {
